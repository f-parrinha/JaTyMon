...
<br>
We test and evaluate our tool with two implementations of well-known consensus protocols: a read/write majority qurom inspired by the work of [https://groups.csail.mit.edu/tds/papers/Attiya/PODC90.pdf](Atty), and a [Multi-Paxos](https://lamport.azurewebsites.net/pubs/lamport-paxos.pdf) protocol.
