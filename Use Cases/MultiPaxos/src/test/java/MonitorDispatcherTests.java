...
public class MonitorDispatcherTests {
    ...
    public void testIllegalActionLogs() throws NoSuchFieldException, IllegalAccessException, HandlerRegistrationException, IOException {
        ...
        // Illegal actions
        monitoredDispatcher.uponPrepareOkMessage(MonitorTestsUtils.TEST_PREPARE_OK_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
        assertEquals(1, logger.getLogTypeCount(IllegalActionLog.class));
        monitoredDispatcher.uponAcceptMessage(MonitorTestsUtils.TEST_ACCEPT_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
        ...
        // Legal actions
        for (int i = 0; i < 10; i++) {
            monitoredDispatcher.uponPrepareMessage(MonitorTestsUtils.TEST_PREPARE_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
            monitoredDispatcher.uponAcceptMessage(MonitorTestsUtils.TEST_ACCEPT_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
            monitoredDispatcher.uponPrepareOkMessage(MonitorTestsUtils.TEST_PREPARE_OK_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
            monitoredDispatcher.uponAcceptOkMessage(MonitorTestsUtils.TEST_ACCEPT_OK_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
        }
