...
public class MonitorTestsUtils {
    ...
    // Timers
    public static final SendBitTimer TEST_SEND_BIT_TIMER = new SendBitTimer();

    // Messages
    public static final AckMessage TEST_ACK_MESSAGE = new AckMessage((byte)1);
    public static final BitMessage TEST_BIT_MESSAGE = new BitMessage((byte)1);
    ...
    // Notifications
    public static final ReceivedAckMessageNotification TEST_ACK_MESSAGE_NOTIFICATION = new ReceivedAckMessageNotification(TEST_ACK_MESSAGE, TEST_HOST);
    ...
    public static final ReceivedBitMessageNotification TEST_BIT_MESSAGE_NOTIFICATION = new ReceivedBitMessageNotification(TEST_BIT_MESSAGE, TEST_HOST);
