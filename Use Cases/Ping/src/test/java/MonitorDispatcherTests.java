import jatymon.babelprojects.ping.protocols.MonitoredDispatcherProtocol;
...
public class MonitorDispatcherTests {
    ...
    public void testIllegalActionLogs() throws NoSuchFieldException, IllegalAccessException, HandlerRegistrationException, IOException {
        ...
        // Illegal actions
        monitoredDispatcher.uponEchoRequestMessage(MonitorTestsUtils.TEST_REQUEST_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
        assertEquals(1, logger.getLogTypeCount(IllegalActionLog.class));
        monitoredDispatcher.uponEchoReplyMessage(MonitorTestsUtils.TEST_REPLY_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
