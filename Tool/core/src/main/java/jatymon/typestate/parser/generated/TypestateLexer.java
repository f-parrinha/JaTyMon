...
public class TypestateLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "T__14", "T__15", "TYPESTATE", 
			"END", "IMPORT", "PACKAGE", "STATIC", "KEYED", "ADD", "MULTIPLY", "DIVIDE", 
			"SUB", "AND", "OR", "NOT", "EQ", "NEQ", "GT", "GEQ", "LT", "LEQ", "TRUE", 
			"FALSE", "AUTO_ASSIGN", "NUMBER", "ID", "WS", "BlComment", "LnComment"
		};
	}
