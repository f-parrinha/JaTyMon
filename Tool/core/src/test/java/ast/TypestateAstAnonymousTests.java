...
public class TypestateAstAnonymousTests extends TypestateAstTester {
    ...
    public void testAnonymousNotEnd2() throws IOException  {
        success(Tests.Anonymous.ANONYMOUS_NOT_END2);
    }
    ...
    public void testAnonymousWithDecisionState() throws IOException  {
        success(Tests.Anonymous.ANONYMOUS_WITH_DECISION_STATE);
    }
}
