...
public class MonitoredDispatcherProtocol extends DispatcherProtocol {
  ...
  @Override
  public void uponBitMessage(BitMessage arg0, Host arg1, short arg2, int arg3) {
    final States oldState = currentState;
    switch (currentState) {
      case Main:
        try {
          currentState = States.Main;
          super.uponBitMessage(arg0, arg1, arg2, arg3);
        } catch(final Exception e) {
          currentState = oldState;
          logger.log(new InternalExceptionLog(TYPESTATE_NAME, e.getMessage()));
        }
      ...
      default:
        try {
          logger.log(new IllegalActionLog(TYPESTATE_NAME, currentState.toString(), "uponBitMessage", ActionType.Input));
          super.uponBitMessage(arg0, arg1, arg2, arg3);
        } catch (final Exception e) {
          currentState = oldState;
          logger.log(new InternalExceptionLog(TYPESTATE_NAME, e.getMessage()));
  ...
  @Override
  public void uponAckMessage(AckMessage arg0, Host arg1, short arg2, int arg3) {
    final States oldState = currentState;
    switch (currentState) {
      case Main:
        try {
          currentState = States.Main;
          super.uponAckMessage(arg0, arg1, arg2, arg3);
        } catch(final Exception e) {
          currentState = oldState;
          logger.log(new InternalExceptionLog(TYPESTATE_NAME, e.getMessage()));
        }
      ...
      default:
        try {
          logger.log(new IllegalActionLog(TYPESTATE_NAME, currentState.toString(), "uponAckMessage", ActionType.Input));
          super.uponAckMessage(arg0, arg1, arg2, arg3);
        } catch (final Exception e) {
          currentState = oldState;
          logger.log(new InternalExceptionLog(TYPESTATE_NAME, e.getMessage()));
