...
public class MonitorDispatcherTests {
    ...
    public void testIllegalActionLogs() throws NoSuchFieldException, IllegalAccessException, HandlerRegistrationException, IOException {
        ...
        // Illegal actions
        monitoredDispatcher.uponReadMessage(MonitorTestsUtils.TEST_READ_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
        assertEquals(1, logger.getLogTypeCount(IllegalActionLog.class));
        monitoredDispatcher.uponWriteMessage(MonitorTestsUtils.TEST_WRITE_MESSAGE, MonitorTestsUtils.TEST_HOST, (short)1, 1);
