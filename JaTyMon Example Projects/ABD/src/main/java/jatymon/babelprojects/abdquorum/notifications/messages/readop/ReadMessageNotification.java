...
public class ReadMessageNotification extends ProtoNotification implements ReceivedMessageNotification {
    public static final short ID = 408;

    private final ReadMessage message;
    private final Host sender;

    public ReadMessageNotification(final ReadMessage message, final Host sender) {
        super(ID);
